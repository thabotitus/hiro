...
%o`, message, error2, detail);
  ...
  // src/js/utils/_localstorage.js
  var GET_LS_STATE = (key) => localStorage.getItem(key);
  var SET_LS_STATE = (key, value) => localStorage.setItem(key, value);

  // src/js/controllers/_hello_controller.js
  ...
  __publicField(hello_controller_default, "targets", ["body", "colourmodeCheckbox"]);

  // src/js/controllers/_easter_eggs_controller.js
  var easter_eggs_controller_default = class extends Controller {
    boom() {
      ...
      <div style="color: #ffffff; width: 100%; height: 100vh; display: flex; align-items: center; justify-content: center; flex-direction: column;">
        ...
        <h1>You pressed the button! \u{1F614}</h1>
  ...
  // src/js/controllers/_navigation_controller.js
  ...
  __publicField(navigation_controller_default, "targets", ["navigation", "offcanvas"]);

  // src/js/controllers/index.js
  var app = new Application();
  var controllers = {
    "hello": hello_controller_default,
    "easter-eggs": easter_eggs_controller_default,
    "navigation": navigation_controller_default
  };
